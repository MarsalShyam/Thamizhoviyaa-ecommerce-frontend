// // frontend/src/pages/Checkout.jsx (Final Merged)
// import React, { useState, useEffect, useCallback } from 'react'
// import { Link, useNavigate } from 'react-router-dom'
// import { motion } from 'framer-motion'
// import { useCart } from '../context/CartContext'
// import { useAuth } from '../context/AuthContext'
// import { FiArrowLeft, FiCreditCard, FiCheckCircle, FiShoppingBag } from 'react-icons/fi'
...
//   // Load user default address (if any)
//   useEffect(() => {
...
//       setLoading(false)
//     }
//   }, [cart, selectedAddress, newAddress, paymentMethod, totalAmount, user, fetchCart, navigate])
...
//     const orderResponse = await axios.post('/api/orders/razorpay/create-order', { totalPrice: totalAmount })
...
//         const verifyResponse = await axios.post('/api/orders/razorpay/verify', {
...
//           await placeOrder({ id: response.razorpay_payment_id })
//         } else {
...
//                     required
//                     className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 resize-vertical"
//                   ></textarea>
//                 </div>
...
//                 <label className={`flex items-center space-x-3 p-4 border rounded-lg cursor-pointer ${paymentMethod === 'razorpay' ? 'border-primary-600 bg-primary-50' : 'border-gray-300 hover:border-primary-500'}`}>
//                   <input
//                     type="radio"
//                     name="paymentMethod"
//                     value="razorpay"
...
//                 </label>
//                 <label className={`flex items-center space-x-3 p-4 border rounded-lg cursor-pointer ${paymentMethod === 'cod' ? 'border-primary-600 bg-primary-50' : 'border-gray-300 hover:border-primary-500'}`}>
//                   <input
//                     type="radio"
//                     name="paymentMethod"
//                     value="cod"
...
//               {cart.map((item) => (
//                 <div key={item._id} className="flex items-center space-x-4 py-3 border-b border-gray-100">
...
//               className="w-full bg-accent-400 hover:bg-accent-500 text-white py-4 rounded-lg font-semibold text-lg mt-6 transition-colors duration-200 disabled:opacity-50"
//             >
//               {loading ? 'Processing...' : paymentMethod === 'cod' ? 'Place Order (COD)' : `Pay ₹${totalAmount}`}
//             </button>
