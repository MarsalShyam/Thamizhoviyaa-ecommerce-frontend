...
const LoginPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Toast already handled inside AuthContext
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="min-h-[80vh] bg-gray-50 section-padding flex items-center justify-center">
      ...
      >
        ...
        {/* Optional Error Display (extra visual feedback, though Toast handles main error) */}
        {error && (
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          {!isLogin && (
            <>
              ...
              <div>
                <label className="input-label flex items-center mb-1">
                  <FiPhone className="w-4 h-4 mr-2 text-primary-600" /> Phone Number (For Verification)
                </label>
                <input
                  type="tel"
                  name="phone"
